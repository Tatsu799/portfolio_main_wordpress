  ...
  <main>
    ...
    <section class="works-top" id="works-top">
      <div class="works-top-wrapper __inner">
        <div class="works-top-wrapper__ttl">
          <div class="ttl fadeRightTrigger">
            <p>制作実績</p>
            <h2 class="ttl-main" data-en="Works"><span>WORKS</span></h2>
          </div>
        </div>
        <div class="works-top-wrapper__con slider fadeUpTrigger">
          <?php
    ...
    <section class="service-top" id="service-top">
      <div class="service-top-wrapper __inner">
        ...
        <div class="service-top-wrapper__con fadeUpTrigger">
    ...
    <section class="news-top" id="news-top">
      <div class="news-top-wrapper __inner">
        <div class="news-top-wrapper__ttl fadeRightTrigger">
          <div class="ttl">
            <p>ニュース</p>
            <h2 class="ttl-main" data-en="news"><span>NEWS</span></h2>
          </div>
        </div>
        <div class="news-top-wrapper__con fadeUpTrigger">
          <?php
            $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
            $the_query = new WP_Query( array(
              'post_status' => 'publish',
    ...
    <section class="about-top" id="about-top">
      <div class="about-top-wrapper __inner">
        ...
        <div class="about-top-wrapper__con">
          <div class="about-top-wrapper__con__box">
    ...
    <section class="contact-top" id="contact-top">
      <div class="contact-top-wrapper __inner">
        ...
        <div class="contact-top-wrapper__con">
          <div class="contact-top-wrapper__con__txt fadeUpTrigger">
            <p>
              お気軽にお問い合わせください。<br>
              3営業日以内にご連絡をさせていただきます。
            </p>
          </div>
          <div class="contact-top-wrapper__con__btn fadeUpTrigger">
